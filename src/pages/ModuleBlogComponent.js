...
import ResourceList from './Website/Documents/components/ResourceList'
import { Button, DatePicker, Divider, Input, Select } from 'antd';
import { useTranslation } from 'react-i18next';
import { useQuery } from '@tanstack/react-query';
import { BLOGS, CACHE_TIME, MINISTRIES, STALE_TIME } from '../constants/CacheAPI';
import { fetchBlogs, fetchMinistryPartner } from '../api/publicRequest';
import { LanguageContext } from '../i18n/LanguageProvider';
import dayjs from 'dayjs';

export default function ModuleBlogComponent(props) {
    ...
    const { data: resourceData, isLoading: isResourceLoading } = useQuery({
        queryKey: [BLOGS, computeQuery, moduleId],
    ...
    useEffect(() => {
        setFilter({ ...filter, lang: lang || "", page: 1 });
    }, [lang])
