...
export const resources = {
    ...
    route: [
        ...
        },
        {
            ...
            path: "/resources/policy-and-strategy",
            children: [],
        },
        {
        ...
        {
            title: getTreeTitle("News and Events"),
            label: 'News and Events',
            key: "News And Events",
            path: "/resources/news-and-events",
            children: [],
        },
        {
            title: getTreeTitle("Report & Publications"),
            label: 'Report & Publications',
            key: "Report And Publications",
            path: "/resources/report-and-publications",
            children: [],
        },
    ]
}