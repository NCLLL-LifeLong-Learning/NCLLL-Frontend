...
export default function GlobeSvg(props = SvgProp) {
    ...
    return (
        <svg class={className} style={{ color: color, backgroundColor: backgroundColor }} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="20 30 220 200" height={height} width={width} xmlns="http://www.w3.org/2000/svg">
