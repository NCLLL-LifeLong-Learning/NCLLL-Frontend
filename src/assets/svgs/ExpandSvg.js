...
export default function ExpandSvg(props = SvgProp) {
    ...
    return (
        <svg class={className} style={{ color: color, backgroundColor: backgroundColor }} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height={height} width={width} xmlns="http://www.w3.org/2000/svg">
