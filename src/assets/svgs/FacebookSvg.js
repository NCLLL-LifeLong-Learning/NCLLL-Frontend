...
export default function FacebookSvg(props = SvgProp) {
    const { height, width, color, backgroundColor } = props;
    return (
        <svg style={{ color: color, backgroundColor: backgroundColor }} width={width} height={height} viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
