...
export default function ArrowSvg(props = SvgProp) {
    const { height, width, color, backgroundColor, rotate } = props;
    return (
        <svg style={{ color: color, backgroundColor: backgroundColor, rotate: rotate }} width={width} height={height} viewBox="0 0 15 22" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
