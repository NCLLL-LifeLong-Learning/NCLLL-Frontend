...
export default function ArrowSvg(props = SvgProp) {
    const { height, width, color, backgroundColor, transform } = props;
    return (
        <svg style={{ color: color, backgroundColor: backgroundColor, transform: transform }} width={width} height={height} viewBox="0 0 15 22" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
