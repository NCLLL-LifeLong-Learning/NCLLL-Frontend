...
export default function HoldingHeartSvg(props = SvgProp) {
    ...
    return (
        <svg class={className} style={{ color: color, backgroundColor: backgroundColor }} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 64 60" height={height} width={width} xmlns="http://www.w3.org/2000/svg">
