...
export default function SideWayArrowSvg(props = SvgProp) {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{ color: color, backgroundColor: backgroundColor }} viewBox="0 0 11 11" width={height} height={width} fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
